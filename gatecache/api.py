...
from gatecache.cache.sqlite_persistence import (
...
from gatecache.serving.neighbor_judge import NeighborJudge
from gatecache.serving.pipeline import Embedder, SemanticCachePipeline
from gatecache.serving.policy import build_anchor_key, build_exact_key, cache_policy_for_route
from gatecache.serving.query_facets import extract_query_facets
...
class SemanticCache:
    ...
    def _lookup_with_forced_semantic_mode(
        ...
        if exact_hit is not None:
            ...
            from gatecache.serving.pipeline import PipelineResponse
